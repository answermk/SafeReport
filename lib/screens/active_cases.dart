...
class ActiveCases extends StatefulWidget {
  ...
  @override
  State<ActiveCases> createState() => _ActiveCasesState();
}
...
class _ActiveCasesState extends State<ActiveCases> {
  ...
  Widget _buildActiveCaseCards() {
    return Column(
      children: [
        // URGENT - assigned to you (no button shown in design)
        _buildCaseCard(
          caseId: '#SP-2025-0001',
          priority: 'URGENT',
          status: 'Active',
          ...
          time: '2 hours ago',
          description:
              'Individual loitering around school entrance during dismissal time...',
        ...
        // Three HIGH priority unassigned cases with Take Case button
        ...List.generate(3, (_) => _buildHighTakeCaseCard()),
      ],
    );
  }

  Widget _buildHighTakeCaseCard() {
    return Padding(
